...
@push('style')
    <style>
        ...
        .rid-banner-style-1 {
            ...
            background: {{$color->slider_backcolor ?? '#C2C2C2'}} !important; /* Fallback background */
        }
...
{{--        </section>--}}
    ...
    <section class="rid-filter-1">
        <div class="container">
            ...
            <div class="filter-box cta-box">
                <h3 class="cta-title">Explore Japan on Two Wheels.</h3>
                <a href="{{ route('motorcycle') }}" class="cta-btn">
                    FIND YOUR RENTAL MOTORCYCLE
                </a>
            </div>
        </div>
    </section>
    ...
    {{--                                aliquip--}}
    {{--                                officia, adipiscing! Sapien consequuntur consectetuer facere potenti? Incididuntmontes--}}
    ...
    {{--                                molestias--}}
    {{--                                nemo a cursus. Metus. Mollit irure posuere eget, sociis, aliquip, ipsum tempus turpis.--}}
    ...
    {{--                                    <p class="rid-test-desc">Maboriosam in a nesciung eget magna dapibus disting tloctio--}}
    {{--                                        in--}}
    {{--                                        the find it per odiy.Maboriosam in a nesciung eget magna dapibus disting tloctio--}}
    {{--                                        in--}}
                ...
                <div class="col-lg-6">
                    <div class="map-container mb-4">
                        <div class="text-center">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d819.1187075672343!2d135.54499482924905!3d34.793993998775676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzTCsDQ3JzM4LjQiTiAxMzXCsDMyJzQ0LjAiRQ!5e0!3m2!1sen!2sjp!4v1538629279601"
...
{{--                                <div class="accordion-body">--}}
{{--                                    <p>You need to be a minimum of 20 years of age with a valid Japanese license or a--}}
{{--                                        valid international drivers license with the motorcycle endorsement applicable--}}
...
{{--                                            here.</a>) You must have a credit card, a residents card or passport if not--}}
{{--                                        a resident.</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                 data-bs-parent="#faqWrap1">--}}
{{--                                <div class="accordion-body">--}}
{{--                                    <p>All our motorcycles are provided with insurance as stipulated for rental vehicles--}}
{{--                                        by law.<br>--}}
...
{{--                                        An excess of 300,000yen is payable on all claims. For mopeds or vehicles from--}}
{{--                                        51cc-250cc, only personal unrestricted damages are covered. Damages that exceed--}}
{{--                                        the amount covered by the insurance policy is assumed by the renter. The vehicle--}}
...
{{--                                 data-bs-parent="#faqWrap1">--}}
{{--                                <div class="accordion-body">--}}
{{--                                    <p>Any damage whatsoever regardless of blame is assumed by the renter and is up to--}}
...
{{--                                 data-bs-parent="#faqWrap1">--}}
{{--                                <div class="accordion-body">--}}
{{--                                    <p>Japan has an extremely varying climate depending on where you are, but basically--}}
{{--                                        cold in winter 0c and up to 40c in summer. Mid June to July is the rainy season,--}}
{{--                                        not too bad for riding as it is not permanent rain however you will need wet--}}
{{--                                        weather gear. July and august are hot and humid, but feels good on a bike, just--}}
{{--                                        don't stop too long! By far the best seasons for riding are March to June, the--}}
...
{{--                                <div class="accordion-body">--}}
{{--                                    <p>Yes and no! If you come from the UK, Australia or New Zealand etc, then it is--}}
{{--                                        very similar as you drive on the left here, however there are very few--}}
{{--                                        roundabouts and more traffic lights like in the US. There are also some stop--}}
{{--                                        intersections which are also like in the US but not in the UK. There are no--}}
{{--                                        strange rules luckily and is reasonably straightforward with common sense. <a--}}
{{--                                                href="https://bikerentaljapan.com/safely">Please see our video</a> on--}}
{{--                                        how to ride safely in Japan.</p>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                <div class="accordion-body">--}}
{{--                                    <p>--}}
{{--                                        <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.maps"--}}
...
{{--                                        downloadable). All locations can be searched in English. For our self guided--}}
{{--                                        tours we ask that the customer downloads <a href="https://maps.me/"--}}
{{--                                                                                    target="_blank">Maps.me</a> with--}}
{{--                                        complete maps for Japan or the area you will be visiting onto their phones. We--}}
...
{{--                                 data-bs-parent="#faqWrap2">--}}
{{--                                <div class="accordion-body">--}}
{{--                                    <p>Although we do have helmets and gear to rent we highly recommend you bring your--}}
{{--                                        own gear, especially a helmet. Helmets are a very personal thing, often--}}
{{--                                        different brands fit differently, sizing can be difficult however we will do our--}}
...
{{--                                        This site has an amazing amount of information about all aspects of driving in--}}
{{--                                        Japan, a must read if this is your first time motoring here.</p>--}}

{{--                                    <p><strong><u><a href="https://www.xe.com/" target="_blank">Currency Conversion</a></u></strong><br>--}}
{{--                                        All rates found on our website are in Japanese Yen (JPY). XE currency conversion--}}
{{--                                        is an easy to use website that can be used to convert our rates to your local--}}
{{--                                        currency.</p>--}}

{{--                                    <p><a href="https://drive.google.com/open?id=1MnuZll_ke0IUo_gQwtCHWwIlifB9vaBT"--}}
{{--                                          target="_blank"><u><strong>Motorcycle Trip Packing List</strong></u></a><br>--}}
{{--                                        We expect you've been planning this for a long time and have it covered, but--}}
{{--                                        please do take a look at this list just to make sure nothing has slipped your--}}
{{--                                        mind.</p>--}}
...
{{--                                        place. We have made up some great tours however there is always much more to see--}}
{{--                                        that have nothing to do with bikes so please have a look and ride there anyway!--}}
{{--                                    </p>--}}

{{--                                    <p><strong><a href="https://www.japan-guide.com/e/e2157.html" target="_blank">Japan--}}
{{--                                                Guide-Osaka</a></strong><br>--}}
{{--                                        Osaka is a unique, lively and interesting city with plenty to offer, more than--}}
{{--                                        we can tell anyone so please check here for yourself.</p>--}}

{{--                                    <p><a href="https://www.holiday-weather.com/osaka/" target="_blank"><strong>Osaka--}}
{{--                                                Weather</strong></a><br>--}}
{{--                                        Japan has one of the most variable climates in the world with a possible 50°c--}}
{{--                                        difference between summer and winter, with a rainy and typhoon season. This site--}}
...
{{--                            <a href="https://www.whatsapp.com/" class="h4 text-black fw-bold" target="_blank">Whatsapp</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--            if (!window.FontAwesome && !$('link[href*="font-awesome"]').length) {--}}
{{--                $('body').addClass('no-fontawesome');--}}
{{--            }--}}
...
{{--                $('.slider-item').slice(0, 3).addClass('active'); // Mark first 3 as active--}}
{{--            });--}}
...
{{--                // Mark the current visible slides as active (3 at a time)--}}
{{--                $('.slider-item').removeClass('active');--}}
{{--                for (let i = 0; i < 3; i++) {--}}
{{--                    $('.slider-item').eq(currentSlide + i).addClass('active');--}}
{{--                }--}}
{{--            });--}}
{{--        });--}}
{{--    </script>--}}
