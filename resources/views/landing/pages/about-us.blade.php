        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="rounded-image-card shadow-sm">
                    <img src="{{ asset('uploads/about_us/pexels-photo-4489749.avif') }}" alt="Phil Cathcart - Vehicle Inspection" class="img-fluid w-100" style="height: 340px; object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="rounded-image-card">
                            <img src="{{ asset('uploads/about_us/pexels-photo-2244746.avif') }}" alt="Engine Inspection" class="img-fluid w-100" style="height: 190px; object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="rounded-image-card">
                            <img src="{{ asset('uploads/about_us/pexels-photo-3807277.avif') }}" alt="Vehicle Panel Assessment" class="img-fluid w-100" style="height: 190px; object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="p-4 di-card h-100">
                        <i class="bx bx-gavel fs-1 mb-3" style="color: var(--di-navy-blue);"></i>
                ...
                <div class="col-md-4">
                    <div class="p-4 di-card h-100">
                        <i class="bx bx-store-alt fs-1 mb-3" style="color: var(--di-navy-blue);"></i>
                ...
                <div class="col-md-4">
                    <div class="p-4 di-card h-100">
                        <i class="bx bx-ship fs-1 mb-3" style="color: var(--di-navy-blue);"></i>
        ...
        <div class="mb-5">
            ...
            <div class="table-responsive rounded border bg-white">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td class="fw-bold"><i class="bx bx-check-circle me-2" style="color: var(--di-navy-blue);"></i>Licensed Dealer Status</td>
                            <td>Fully registered and licensed motor vehicle trader in Japan.</td>
                        </tr>
                        <tr>
                            <td class="fw-bold"><i class="bx bx-dollar-circle me-2" style="color: var(--di-navy-blue);"></i>Direct JPY Pricing</td>
                            <td>Vehicle listings display actual auction or dealer prices in Japanese Yen (JPY).</td>
                        </tr>
                        <tr>
                            <td class="fw-bold"><i class="bx bx-search-alt me-2" style="color: var(--di-navy-blue);"></i>Expertly Assessed Listings</td>
                        ...
                        <tr>
                            <td class="fw-bold"><i class="bx bx-receipt me-2" style="color: var(--di-navy-blue);"></i>Flat Service Fees</td>
                            <td>We charge a clear handling fee to manage the purchase, paperwork, and transport, with zero vehicle price markups.</td>
                        </tr>
                        <tr>
                            <td class="fw-bold"><i class="bx bx-globe me-2" style="color: var(--di-navy-blue);"></i>Global Export Specialists</td>
        ...
        <div class="my-5 pt-3">
            ...
            <div class="di-card mb-4 overflow-hidden">
                <div class="row g-0 align-items-center">
                    <div class="col-md-6">
                        <img src="{{ asset('uploads/about_us/car_1785251750_6a68c7a61a8c1.webp') }}" alt="1994 Nissan Skyline GT-R V-Spec II" class="img-fluid h-100 w-100" style="min-height: 290px; object-fit: cover;">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="di-card mb-4 overflow-hidden">
                <div class="row g-0 align-items-center flex-row-reverse">
                    <div class="col-md-6">
                        <img src="{{ asset('uploads/about_us/pexels-photo-170811.avif') }}" alt="BMW M Performance European Sports Car" class="img-fluid h-100 w-100" style="min-height: 290px; object-fit: cover;">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body p-4 p-lg-5">
