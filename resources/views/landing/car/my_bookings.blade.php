        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0">
                    ...
                    {{-- <button type="button" class="btn-close clear_request" data-bs-dismiss="modal"
                ...
                <form method="POST" enctype="multipart/form-data" id="bookingProcessingForm" class="p-2">
                    ...
                    <div class="modal-footer">
                        ...
                        {{-- <button type="{{ (!$user)?'button':'submit' }}"
                            class="btn btn-danger {{ (!$user)?'checkLogin':'bookingProcessing' }}"><i
                                class="bx bx-loader spinner me-2" style="display: none" id="processingBtnSpinner"></i>
                            Request To Book</button>--}}
                        <button type="submit" class="btn btn-danger bookingProcessing"><i class="bx bx-loader spinner me-2"
                                style="display: none" id="processingBtnSpinner"></i>
                            Request To Book
                        </button>
...
@section('main')
                ...
                <form method="POST" enctype="multipart/form-data" id="booking-form">
                    ...
                    <div class="mb-4">
                        ...
                        {{-- <div class="selected-car-placeholder">--}}
                            {{-- <p class="mb-0">No cars selected yet. <a href="{{ route('car') }}">Add a car</a> to get
                                started.</p>--}}
                            {{-- </div>--}}
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex gap-2">
                                <div class="col-md-6 mb-3 w-33">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control datepicker b-round-10" id="from"
                                            name="start_date" value="{{ date('Y-m-d') }}" placeholder="Start Date">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 w-33">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control pickuptime b-round-10" id="pickupTime"
                                            name="start_time" placeholder="Pickup Time" autocomplete="off">
                                    </div>
                            ...
                            <div class="d-flex gap-2">
                                <div class="col-md-6 mb-3 w-33">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bx bxs-calendar"></i></span>
                                        <input type="text" class="form-control datepicker b-round-10" id="to"
                                            name="end_date" value="{{ date('Y-m-d') }}" placeholder="End Date">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3 w-33">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control dropoffTime b-round-10" id="dropoffTime"
                                            name="end_time" placeholder="Drop Off Time" autocomplete="off">
                                    </div>
                    ...
                    <div class="mb-4 center-padding-x">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control b-round-10" id="email" name="email"
                                        placeholder="Enter a valid email" value="{{ $user->email ?? '' }}" required="">
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control b-round-10" rows="5" id="comment" name="comment"
                                    form="booking-form"
    ...
    ">
                        <input type="checkbox" class="form-check-input" name="policy_status" id="policy_status" value="1"
                            required="" style="margin-right: 4px">
                        <label class="form-check-labe" for="policy_status">
                            <strong>
                                "By Clicking you agree to our
                                <a target="_blank" href="{{ route('rental.policies') }}" class="text-primary">Terms and
                                    conditions</a> and I have read them ."</strong>
                        </label>
                    </div>
