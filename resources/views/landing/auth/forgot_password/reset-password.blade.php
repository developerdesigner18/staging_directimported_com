                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 auth-image">
                            <div>
                                ...
                                <p class="mb-0">Almost there! Set your password to access your account and manage your booking.</p>
                            </div>
                        </div>
  ...
  <input type="hidden" name="token" id="token" value="{{ $token }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="email"
                                               class="form-control" placeholder="your@email.com" value="{{ request()->get('email') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="bg-transparent border btn btn-outline-secondary text-black" onclick="togglePassword('confirmPassword', this)">
                                            <i class="bx bx-eye"></i>
                                        </button>
                                    </div>
                                    <label id="confirm-password-error" class="text-danger error" for="confirmPassword" style="display: none"></label>
                                </div>

                                    <!-- Submit -->
                                    <button type="submit" class="btn btn-primary w-100" id="resetBtn"> <i class="bx bx-loader spinner me-2" style="display: none" id="resetBtnSpinner"></i>Reset</button>
...
@section('script')
  ...
  password: {
                ...
                submitHandler: function (form, e) {
                    e.preventDefault();
                    $.ajax({
                        url: "{{ route('password.update') }}", // Update with your register route
                        method: "post",
                        dataType: "json",
