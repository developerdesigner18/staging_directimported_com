...
@section('main')
    ...
    if ($val === 'confirmed') {
        ...
        $badgeClass = 'bg-light text-dark';
                                ...
                                @endphp
                                <span class="payment-badge {{ $badgeClass }}" style="border-radius: 9999px; padding: 4px 12px; font-weight: 600; font-size: 0.75rem; vertical-align: middle; margin-left: 10px; display: inline-block;">{{ $statusText }}</span>
                            </div>
                        </div>
                        ...
                        <div class="accessories-section">
                            ...
                            @if($selectedAccessories && $selectedAccessories->isNotEmpty())
                                <div class="mb-3">
                                    <h6 class="text-dark fw-bold" style="font-size: 0.9rem; margin-bottom: 5px;">Extra Accessories:Selected</h6>
                                    <ul class="accessory-list">
                ...
                <div class="col-md-6">
                    <div class="date-box">
                        ...
                        <div class="time-display">
                            {{ $booking->start_date ? $booking->start_date->format('l') : '' }}, {{ $booking->start_time ? \Carbon\Carbon::parse($booking->start_time)->format('h:i A') : '10:00 AM' }}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="date-box">
                        ...
                        <div class="time-display">
                             {{ $booking->end_date ? $booking->end_date->format('l') : '' }}, {{ $booking->end_time ? \Carbon\Carbon::parse($booking->end_time)->format('h:i A') : '10:00 AM' }}
                        </div>
                    </div>
                </div>
            </div>
