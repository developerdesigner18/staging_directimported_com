...
@section('script')
    <script>
        var dataTable = $('#categoryDT').DataTable({
            ...
            ajax: {
                url: '{{ route("admin.category.list",['type' => 'bike']) }}',
                type: "POST",
                dataType: "JSON",
                data: function (f) {
                    f._token = "{{csrf_token()}}";
        ...
        function removeCategory(id, element) {
            Swal.fire({
                ...
                if (t.value) {
                    $.ajax({
                        url: "{{route('admin.category.delete',['type' => 'bike'])}}",
                        dataType: "JSON",
                        method: "POST",
                        data: {
                            "id": id,
        ...
        function getCategory(id, element) {
            $.ajax({
                url: "{{route('admin.category.edit',['type' => 'bike'])}}",
                dataType: "JSON",
                method: "POST",
                data: {
                    "id": id,
        ...
        $(document).ready(function () {
            ...
            $("#addCategoryForm").validate({
                ...
                submitHandler: function (form, e) {
                    e.preventDefault();
                    $.ajax({
                        url: "{{route('admin.category.add',['type' => 'bike'])}}",
                        method: "post",
                        dataType: "json",
            ...
            $("#editCategoryForm").validate({
                ...
                submitHandler: function (form, e) {
                    e.preventDefault();
                    $.ajax({
                        url: "{{route('admin.category.update',['type' => 'bike'])}}",
                        method: "post",
                        dataType: "json",
                        data: new FormData(form),
                        processData: false,
