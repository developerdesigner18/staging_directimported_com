    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">Manage Specifications: {{ $car->name }}</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.car.index') }}">Car Management</a></li>
                ...
                <div class="card-body">
                    <form id="specsForm">
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ route('admin.car.index') }}" class="btn btn-light">Back to List</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            $("#specsForm").submit(function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.car.specs.update', $car->id) }}",
                    method: "POST",
                    data: form.serialize(),
                    beforeSend: function () {
