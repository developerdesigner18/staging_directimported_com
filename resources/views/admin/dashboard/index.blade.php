                    ...
                    <div class="col-12">
                        ...
                        >
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Welcome Back, {{Auth::guard('admin')->user()->name ?? Auth::guard('employee')->user()->first_name }}!</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="#" class="text-decoration-underline">View all bikes</a>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="{{ route('admin.booking.index') }}" class="text-decoration-underline">View bookings</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
