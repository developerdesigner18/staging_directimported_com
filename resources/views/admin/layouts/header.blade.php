            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="#" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{asset('assets/logo/main.png')}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('assets/logo/main.png')}}" alt="" height="17">
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                 src="{{Auth::guard('admin')->user()->profile_img ?? asset('uploads/admin_profiles/default_profile.webp')}}"
                                 alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span
                                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{Auth::guard('admin')->user()->name ?? Auth::guard('employee')->user()->first_name}}</span>
