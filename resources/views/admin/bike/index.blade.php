    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                <h4 class="mb-sm-0">Bike Management</h4>
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                ...
                <button type="button" class="btn btn-success btn-label" data-bs-toggle="modal" data-bs-target="#bannerModal"><i class="ri-image-add-line label-icon align-middle fs-16 me-2"></i>Bike Banner</button>
            </div>
        </div>
