...
if (!defined('USER_PROFILE_IMAGE_PATH'))
    define('USER_PROFILE_IMAGE_PATH', 'uploads/user_profiles/');

if (!defined('USER_DOCUMENT_PATH'))
    define('USER_DOCUMENT_PATH', 'uploads/user_documents/');

if (!defined('ADMIN_PROFILE_IMAGE_PATH'))
    define('ADMIN_PROFILE_IMAGE_PATH', 'uploads/admin_profiles/');

if (!defined('TINY_MCE_UPLOAD_PATH'))
    define('TINY_MCE_UPLOAD_PATH', 'uploads/tinymce_files/');

if (!defined('SLIDER_PATH'))
    define('SLIDER_PATH', 'uploads/slider_images/');
